    ...
    <main className="min-h-screen overflow-hidden bg-slate-950 text-white">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mt-5 max-w-xl text-base leading-7 text-slate-300 md:text-lg">
              Vido4K helps you prepare browser downloads from direct video file links. It supports MP4, WebM, MOV, M4V and OGG file URLs, with clear errors for unsupported platform links.
            </p>
      ...
      <section id="how-it-works" className="mx-auto max-w-6xl px-5 py-10">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6 md:p-8">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-4">
            ...
            <Step number="2" title="Check video" text="The page validates the URL format and file type." />
            <Step number="3" title="Prepare file" text="Choose a quality label and clean file name." />
            <Step number="4" title="Download or error" text="Get a download option or a clear unsupported-link message." />
          </div>
        </div>
      </section>
      ...
      <section id="seo-content" className="mx-auto max-w-6xl px-5 py-10">
        <div className="grid gap-5 md:grid-cols-2">
          <ArticleCard
            title="Direct MP4 and WebM downloader"
            text="Vido4K is made for direct video file links that already end with video extensions such as .mp4, .webm, .mov, .m4v or .ogg. This keeps the tool simple, fast and safer for users who already have permission to download the file."
          />
          <ArticleCard
            title="4K and 2K video labels"
            text="The 4K, 2K, Full HD and HD options are quality labels for organizing your download. The actual video quality depends on the original direct file link provided by the user."
          />
        </div>
      </section>
      ...
      <section id="faq" className="mx-auto max-w-6xl px-5 py-10">
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2">
          <Faq
            q="Can Vido4K download protected platform videos?"
            a="No. Vido4K does not bypass protected platforms, login pages, paywalls or platform restrictions. It is for direct video file links only."
          />
          <Faq
          ...
          <Faq
            ...
            a="No. This design works in the browser for direct file links and does not upload user videos to your server."
          />
          <Faq
...
function validateUrl(value) {
  ...
  try {
    ...
    return {
      ok: false,
      type: "invalid",
      message: "Please enter a valid URL, for example https://example.com/video.mp4."
    };
  }
  ...
  if (isBlocked) {
    return {
      ...
      type: "platform",
      message:
        "This looks like a protected platform link. Vido4K cannot download protected platform videos. Use official download options or direct video files you own."
    };
  }
